...
namespace ChangeNotification.Service.Authentication.Settings
{
    public class TokenSettings(IOptions<AdSettings> adSettings, IOptions<UserCredentials> userCredentials)
    {
